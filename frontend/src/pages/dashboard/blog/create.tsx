...
export default function Dashboard() {
    ...
    const handleSubmit = (event: { preventDefault: () => void; }) => {
      ...
      // delete updateBlogPostData.statusCode;
      // delete updateBlogPostData.message;
      updateBlogPostData.author = getAuthorName(+updateBlogPostData.authorId);
      updateBlogPostData.createdOn = new Date()
        .toISOString()
        .slice(0, 19)
        .replace("T", " ");
      updateBlogPostData.modifiedOn = updateBlogPostData.createdOn;
            ...
            <div className="row">
              ...
              <main className="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div className="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                  <h1 className="h2">Create Blog Post</h1>
                </div>
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-3">
                      ...
                      <select
                        ...
                        className="form-control"
                      >
                        {users?.filter((user: any) => user.author).map((user: any) => (
