...
export default function Dashboard() {
    ...
    const deleteBlogPost = (blogPostId: number) => {
                    ...
                    <tbody>
                      {blogPosts.map((blogPost) => (
                        <tr key={blogPost.id}>
                          ...
                          <td>
                            {format(blogPost.createdOn, "dd/MM/yyyy HH:mm")}
                          </td>
                          <td>
                            {format(blogPost.modifiedOn, "dd/MM/yyyy HH:mm")}
                          </td>
                          <td>
                            <button
                              className="btn btn-primary"
                              onClick={() =>
                                router.push(`/dashboard/blog/${blogPost.id}`)
                              }
                            >
                              View
                            </button>
