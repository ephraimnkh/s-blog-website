...
export default function Dashboard() {
    ...
    useEffect(() => {
        fetch("http://localhost:8080/blog-tag")
        .then((res) => res.json())
        .then((data) => {
            setBlogTags(data);
          })
    ...
    const deleteUser = (userId: number) => {
      fetch(`http://localhost:8080/blog-tag/${userId}`, { method: "DELETE" })
        .then((res) => res.json())
        .then((deleteResponse) => {
          router.reload();
        })
                  ...
                  <table className="table table-striped table-sm">
                    <thead>
                      <tr>
                        ...
                        <th scope="col"></th>
                        <th scope="col">
                          <svg className="bi" style={{ cursor: "pointer " }}>
