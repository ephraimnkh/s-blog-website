            ...
            <div className="col-md-6">
              <div className="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                <div className="col p-4 d-flex flex-column position-static">
                  ...
                  <h3 className="h3 mb-0">Post title</h3>
          ...
          <div className="row g-5">
            <div className="col-md-8">
              ...
              <article className="blog-post">
                ...
                <p>
                  ...
                  lists, tables, images, code, and more are all supported as
                  expected.
                </p>
                <hr />
                <p>
                  ...
                  repeat it often to keep the demonstration flowing, so be on
                ...
                <h3 className="h3">Example lists</h3>
                <p>
                  This is some additional paragraph placeholder content. It{"'"}
                  s a slightly shorter version of the other highly repetitive
                ...
                <h2 className="h2">Inline HTML elements</h2>
                <p>
                ...
                <h3 className="h3">Sub-heading</h3>
                <p>
                  This is some additional paragraph placeholder content. It has
                  been written to fill the available space and show how a longer
                  snippet of text affects the surrounding content. We{"'"}ll
              ...
              <article className="blog-post">
                ...
                <h3 className="h3">Example table</h3>
            ...
            <div className="col-md-4">
              <div className="position-sticky" style={{ top: "2rem" }}>
                    ...
                    <li>
                      ...
                      >
                        ...
                        <div className="col-lg-8">
                          <h6 className="h6 mb-0">Example blog post title</h6>
                ...
                <div className="p-4">
                  <h4 className="h4 fst-italic">Archives</h4>
